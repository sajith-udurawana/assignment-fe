...
function ProjectsPage() {
  ...
  const { data, isFetching, error } = useGetAllProjectsQuery({ skip: true });
  // Search query
      ...
      <div className="container py-3">
        ...
        <div className="row mb-3">
          <div className="col">
            <Stack spacing={16}>
              ...
              <Stack.Item>
                <Button as={Link} to={"/project"} appearance="primary">
                  Add Project
                </Button>
              </Stack.Item>
            </Stack>
        ...
        <div className="row">
          <div className="col-12">
            {isFetching && (
              <div className="alert alert-warning">Loading projects...</div>
            )}
            {error && <div className="alert alert-danger">Error: {error}</div>}
            {!projects.length && !error && !isFetching && (
              <div className="alert alert-warning">No projects!</div>
            )}
          </div>
        </div>
        {/*Project list*/}
